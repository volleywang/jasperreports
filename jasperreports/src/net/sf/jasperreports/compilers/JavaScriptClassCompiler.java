...
public class JavaScriptClassCompiler extends JavaScriptCompilerBase
{
	 ...
	 */
	public static final String PROPERTY_OPTIMIZATION_LEVEL = JRProperties.PROPERTY_PREFIX
	 ...
	 */
	public static final String PROPERTY_EXPRESSIONS_PER_SCRIPT = JRProperties.PROPERTY_PREFIX
	 ...
	 * a single Java class.
	 */
	public static final String PROPERTY_SCRIPT_MAX_SIZE = JRProperties.PROPERTY_PREFIX
			...
			File tempDirFile) throws JRException
	{
		...
		try
		{
			int expressionsPerScript = JRProperties.getIntegerProperty(PROPERTY_EXPRESSIONS_PER_SCRIPT);
			int scriptMaxLength = JRProperties.getIntegerProperty(PROPERTY_SCRIPT_MAX_SIZE);
			
			int optimizationLevel = JRProperties.getIntegerProperty(PROPERTY_OPTIMIZATION_LEVEL);
